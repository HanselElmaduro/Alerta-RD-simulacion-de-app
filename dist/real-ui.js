...
export function createRealUI({onChange,onDemo,notify,loadCloud=()=>import('./cloud.js').then(m=>m.connectCloud())}){
 ...
 function reset(){epoch++;session=null;health=null;healthError='';model={profile:null,contacts:[],events:[],deliveries:[]};editor=null;detail=null;profileEdit=false;recovery=null;dialog.close();}
